...
label1 = Label(root, text="Hey User, Welcome to Denomination Calculator", bg="lightblue")
label1.place(relx = 0.5, y=340, anchor=CENTER)

def msg():
    MsgBox = messagebox.showinfo("Alert", "Do you want to calculate the domination count?")
    if MsgBox == 'ok':
        topwin()
